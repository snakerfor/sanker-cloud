...
import com.snaker.common.exception.file.FileSizeLimitExceededException;
import com.snaker.common.exception.file.InvalidExtensionException;
...
public class FileUploadUtils {
    ...
    public static final String BIG_FILE_NAME = "bigFile";
...
//        }
    ...
    public static String getFileDir() {
        String path = FileUtils.getSessionIsolatedPath(BIG_FILE_NAME);
        log.info("【生成临时文件夹位置:{}】", path);

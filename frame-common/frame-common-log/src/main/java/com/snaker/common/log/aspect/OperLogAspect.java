package com.snaker.common.log.aspect;
...
import com.snaker.common.log.enums.BusinessStatus;
import com.snaker.common.log.event.SysOperLogEvent;
import com.snaker.common.utils.AddressUtils;
...
import com.snaker.common.utils.spring.SpringContextHolder;
...
{
    // 配置织入点
    @Pointcut("@annotation(com.snaker.common.log.annotation.OperLog)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e)
    {
        try
        {
            ...
            String username = request.getHeader(Constants.CURRENT_LOGINNAME);

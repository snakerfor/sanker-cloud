package com.snaker.system.exception;

import com.snaker.common.core.domain.R;
import com.snaker.common.exception.RuoyiException;
import com.snaker.common.exception.UnauthorizedException;
import com.snaker.common.exception.ValidateCodeException;
...
public class GlobalExceptionHandler {
    ...
    public R handleException(Throwable e) throws Exception {
        logger.error(e.getMessage(), e);
        return R.error("服务器错误，请联系管理员");
    }

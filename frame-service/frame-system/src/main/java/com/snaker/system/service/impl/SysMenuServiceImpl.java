...
import com.snaker.system.domain.SysMenu;
import com.snaker.system.domain.SysRole;
import com.snaker.system.domain.SysUser;
import com.snaker.system.mapper.SysMenuMapper;
import com.snaker.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    @Override
    public Boolean isExistPermByUserId(String perm, Long userId) {
        Set<String> perms = selectPermsByUserId(userId);
        // 判断是否为管理员
        if (userId == 1l) {
            return true;
        }

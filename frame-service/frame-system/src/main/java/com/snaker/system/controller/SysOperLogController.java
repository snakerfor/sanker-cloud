...
import com.snaker.common.utils.poi.ExcelUtil1;
import com.snaker.system.domain.SysOperLog;
import com.snaker.system.service.ISysOperLogService;
...
public class SysOperLogController extends BaseController
{
    ...
    @PostMapping("/export")
    public R export(SysOperLog operLog) throws Exception {
        List<SysOperLog> list = sysOperLogService.selectOperLogList(operLog);
        ExcelUtil1<SysOperLog> util = new ExcelUtil1<SysOperLog>(SysOperLog.class);

...
import com.snaker.activiti.vo.ProcessInsVo;
...
public class ProcessInsController extends BaseController
{
    ...
    public R remove(String ids, String reason) throws Throwable {
        ...
        for (String id : idArr)
        {
            ...
            bizBusiness.setProcInstId(pi.getProcessInstanceId());//ddddd

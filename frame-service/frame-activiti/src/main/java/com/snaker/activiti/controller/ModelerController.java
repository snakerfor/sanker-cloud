...
import com.snaker.activiti.domain.ActReModel;
import com.snaker.activiti.service.IActReModelService;
...
public class ModelerController extends BaseController
{
    ...
    public Object editModel(@PathVariable("id") String id) throws UnsupportedEncodingException
    {
        return "redirect:/modeler.html?modelId=" + id;
    }
    /**

...
import com.snaker.activiti.domain.BizPurchase;
import com.snaker.activiti.service.IBizBusinessService;
import com.snaker.activiti.service.IBizPurchaseService;
...
public class BizPurchaseController extends BaseController
{
     ...
     */
    @PostMapping("save")
    public R addSave(@RequestBody BizPurchase purchase) throws Throwable
    {
